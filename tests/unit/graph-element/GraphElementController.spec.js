...
describe('GraphElementController', () => {
    ...
    describe("removeTagFlow", () => {
        xit("can when center is a tag", async () => {
            let scenario = await new AroundTodoTagScenario();
            let center = scenario.getCenterInTree();
        ...
        xit("can when parent is a normal vertex", async () => {
            let scenario = await new SingleAndTaggedToEventScenario();
            let single = scenario.getCenterInTree();
            await single.controller().showTags(true, false, true);
            expect(
        ...
        xit("can for tag group vertex", async () => {
            let scenario = await new AroundTodoTagScenario();
        ...
        xit("can when center tag and tag relation before simple vertex", async () => {
