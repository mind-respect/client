...
export default {
  ...
  data: function () {
    I18n.i18next.addResources("en", "register", {
      ...
      warning: "The application is under development and for the moment works only for the latest versions of Chrome."
    });
    I18n.i18next.addResources("fr", "register", {
      ...
      warning: "L'application est en développement et pour l'instant ne fonctionne que pour les dernières versions de Chrome"
    });
    return {
      Rules: Rules,
      valid: true,
