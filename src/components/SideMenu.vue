  ...
  >
    <v-layout fill-height>
      <v-navigation-drawer
          ...
          dark
      >
        <v-card flat class="text-center" color="transparent" dark>
          ...
          <v-card-title class="text-subtitle-1" v-show="$store.state.sideMenuFlow !== false">
            <div class="grey-lighten-1 text-left">
              <v-skeleton-loader
                  class="mt-4"
                  type="text"
                  width="200"
          ...
          <div v-show="$store.state.sideMenuFlow !== false" class="text-left">
            ...
            <v-tabs-items v-model="tabMenu" color="transparent" dark>
              <v-tab-item>
                <p v-show="!noteCanDo"
                   class="pt-4 grey-lighten-1 text-center"
        ...
        <template v-slot:append v-if="$vuetify.breakpoint.lgAndUp">
          <router-link to="/welcome" class="no-style-link pl-12 pb-12">
            <img
                :src="require('@/assets/logo-horizontal-white-small.png')"
                height="44"
                alt="mindrespect.com"
            >
          </router-link>
...
.side-menu .theme--dark.v-expansion-panels .v-expansion-panel {
  background-color: transparent !important;
}
</style>